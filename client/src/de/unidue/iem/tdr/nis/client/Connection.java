 ...
 * <p>
 * Diese Klasse erm�glicht die Kommunikation mit dem Server. Verbindungsauf und
 * -abbau sind Ihnen in der Klasse {@link Client} schon vorgegeben. F�r Sie sind
...
public class Connection {
     ...
     *
     * @param userId   Matrikelnr des Benutzers
     * @param password Passwort des Benutzers
     * @return true, wenn die Anmeldung erfolgreich war, ansonsten false.
     */
    public boolean auth(int userId, String password) {
     ...
     *
     * @param taskId Identifikator der gew�nschten Aufgabe
     ...
     * @return Aufgabe in Form von TaskObject
     */
    public TaskObject getTask(int taskId, String[] params) {
     ...
     */
    public void sendMoreParams(TaskObject task, String[] params) {
    ...
    /**
     * Sendet eine L�sung an den Server
     *
     * @param solution L�sung des Studierenden
     */
    public boolean sendSolution(String solution) {
    ...
    /**
     * Empf�ngt eine Antwort vom Server. Der Inhalt wird in this.input
     ...
     *
     * @param task TaskObject, das mit Daten gef�llt werden soll
     */
